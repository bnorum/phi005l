...
public class TransitionImage : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.GetChild(3).position = transform.GetChild(2).position;
    ...
    void Update()
    {
        ...
        if (transitioning) {
            ...
            transform.GetChild(1).position = Vector3.Lerp(transform.GetChild(1).position, startPos1, 0.03f);
            transform.GetChild(2).position = Vector3.Lerp(transform.GetChild(2).position, startPos2, 0.03f);
        }
